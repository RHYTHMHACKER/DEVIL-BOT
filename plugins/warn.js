...
if (warn !== 0) {
    ...
    await m.sendMessage("```SUBSCRIBE https://youtube.com/c/NSproGAMERSYT1```");
...
e.addCommand({pattern: 'reset warn', fromMe: true, desc:'Resets the warn count of the user script by NSproGAMERSYT '}, (async (m, mat) => { 
    ...
    await m.sendMessage("```SCRIPT WAS CREATED BY NSproGAMERSYT ```");
